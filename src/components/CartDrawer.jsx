            ...
            {cartItems.length === 0 ? (
              <div className="text-center py-16 space-y-4">
                ...
                <p className="text-xs text-gray-500 max-w-xs mx-auto">
                  Explore our sarees, jewellery & fashion collections to discover beautiful products.
                </p>
                <button
                  onClick={() => {
                    setIsCartOpen(false);
          ...
          {cartItems.length > 0 && (
            <div className="p-4 sm:p-5 bg-white border-t border-gray-100 space-y-3">
              ...
              <form onSubmit={handleApplyCoupon} className="flex gap-2">
                <input
                  type="text"
                  placeholder="Enter promo code (e.g. SRI10)"
                  value={couponCode}
              ...
              {couponApplied && (
                <div className="text-[11px] text-emerald-700 bg-emerald-50 p-2 rounded flex items-center gap-1">
                  ...
                  <span>Promo code SRI10 applied! 10% discount subtracted.</span>
                </div>
              )}
              {couponError && (
