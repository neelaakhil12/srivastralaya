...
export default function WhatsAppFloatingButton() {
  ...
  const whatsappNumber = "919618093699";
  const defaultMessage = "Hello Sri Vastralaya, I would like to know more about your products.";
  const [customMsg, setCustomMsg] = useState(defaultMessage);

  const openWhatsApp = (msgToUse) => {
    const encoded = encodeURIComponent(msgToUse || defaultMessage);
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex flex-col items-end max-w-[calc(100vw-2rem)]">
        ...
        <div className="mb-3 w-[calc(100vw-2rem)] sm:w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden animate-slideUp">
          <div className="bg-[#075E54] text-white p-3.5 sm:p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-bold text-xs sm:text-sm">Sri Vastralaya Support</h4>
          ...
          <div className="p-3.5 sm:p-4 bg-[#ECE5DD] space-y-3">
            <div className="bg-white p-3 rounded-lg rounded-tl-none shadow-xs text-xs text-gray-800 space-y-1">
              ...
              <span className="text-[10px] text-gray-400 block text-right">Pranu</span>
            </div>
      ...
      <button
        ...
        aria-label="Chat on WhatsApp with Sri Vastralaya"
      >
